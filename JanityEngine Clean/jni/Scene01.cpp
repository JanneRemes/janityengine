...
void Scene01::Initialize()
{
	...
	//gaia_cloud =		new Mesh(0, 0, 0, 0.11f,"Scene01/planet.obj");
	//luna1 =			new Mesh(0, 0, 0, 0.1f, "Scene01/planet.obj");
	//luna2 =			new Mesh(0, 0, 0, 0.1f, "Scene01/planet.obj");
	//luna3 =			new Mesh(0, 0, 0, 0.1f, "Scene01/planet.obj");
	//luna4 =			new Mesh(0, 0, 0, 0.1f, "Scene01/planet.obj");
	//luna5 =			new Mesh(0, 0, 0, 0.1f, "Scene01/planet.obj");
	...
	gaia			->SetTexture("Scene01/planet.tga");
	gaia_cloud		->SetTexture("Scene01/planet_clouds.tga");
	luna1			->SetTexture("Scene01/planet.tga");
	luna2			->SetTexture("Scene01/planet.tga");
	luna3			->SetTexture("Scene01/planet.tga");
	luna4			->SetTexture("Scene01/planet.tga");
	luna5			->SetTexture("Scene01/planet.tga");


	bg = new Mesh(0,-8,0, 2.0f, "Scene01/testi.obj");
	bg->Rotate(90,1,0,0);
	bg->SetProgram(Program);
	bg->SetTexture("Scene01/space.tga");
